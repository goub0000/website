document.addEventListener('DOMContentLoaded', function() {
    ...
    // Experience section collapsible functionality
    ...
    if (experienceHeaders.length > 0) {
        ...
        experienceHeaders.forEach(header => {
            ...
            header.addEventListener('click', function() {
                // Toggle active class on parent experience item
                const experienceItem = this.parentElement;
                
                // Check if currently active
                const wasActive = experienceItem.classList.contains('active');
                ...
                // Then open this one if it wasn't active before
                if (!wasActive) {
                        ...
                        setTimeout(() => {
                            ...
                            if (progressBar) {
                                ...
                                if (width && width.includes('width')) {
                                    progressBar.style.width = width.split(':')[1].trim();
                                }
                            }
                        }, 300);
    ...
    if (skillsGrid) {
        ...
        document.querySelectorAll('.skill').forEach(skill => {
            ...
            if (progressBar) {
                ...
                if (originalWidth && originalWidth.includes('width')) {
